...
# Audio HAL
#
TARGET_KERNEL_CONFIG_OVERRIDES += device/intel/mixins/audio/hsw_alc282_mcghal/kernel_defconfig_overlay
...
PRODUCT_COPY_FILES += \
    device/intel/mixins/audio/hsw_alc282_mcghal/audio_effects.conf:system/vendor/etc/audio_effects.conf

# Audio policy file
PRODUCT_COPY_FILES += \
    device/intel/mixins/audio/hsw_alc282_mcghal/audio_policy.conf:system/etc/audio_policy.conf

# Audio asound file
PRODUCT_COPY_FILES += \
    device/intel/mixins/audio/hsw_alc282_mcghal/asound.conf:system/etc/asound.conf
